...
window.addLoadListener ->
  examplesElem = document.querySelector('#examples')
  ...
  for example, index in examples
    ...
    if ast
      ...
      container.classList.add 'examples-container'
      ...
      examplesElem.appendChild container
    else
      examplesElem.appendChild document.createTextNode('error al procesar')
