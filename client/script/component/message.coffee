window.ERROR_ELEMENT =
  ...
  REFERENCIA_MULTIPLE_ELIMINACION_CONJUNCION:
    content: 'Para justificar una eliminación de la conjunción se '  +
      'debe remitir a una única fórmula previa'
  REFERENCIA_A_LINEA_POSTERIOR:
    content: 'Toda fórmula que se agrega en la derivación debe estar justificada ' +
      'por una o varias líneas previas'
  INTRODUCCION_CONJUNCION_CONECTOR_INCORRECTO:
    content: 'La introducción de la conjunción remite indefectiblemente a una ' +
      'formula que tiene el símbolo Λ como conector dominante'
  INTRODUCCION_DISYUNCION_CONECTOR_INCORRECTO:
    content: 'La introducción de la disyunción remite indefectiblemente a una ' +
      'formula que tiene el símbolo V como conector dominante'
  INTRODUCCION_CONDICIONAL_CONECTOR_INCORRECTO:
    content: 'La introducción de la condicional remite indefectiblemente a una ' +
      'formula que tiene el símbolo → como conector dominante'
  INTRODUCCION_CONDICIONAL_FALTA_ITERACION:
    content: 'La aplicación correcta de la regla de introducción del ' +
      'condicional remite a un contexto de suposición. El contenido del ' +
      'supuesto inicial de la regla de introducción del condicional es ' +
      'siempre el antecedente del condicional que se pretende justificar'
  INTRODUCCION_NEGACION_FALTA_NAGACION:
    content: 'La introducción de la negación remite indefectiblemente a una ' +
      'formula que tiene el símbolo ¬ como conector dominante'
  INTRODUCCION_NEGACION_FALTA_ITERACION:
    content: 'La aplicación correcta de la regla de introducción de la ' +
      'negación remite a un contexto de suposición. El contenido del ' +
      'supuesto inicial de la regla de introducción de la negación es ' +
      'siempre una fórmula contradictoria a la que se pretende arribar ' +
      'con la regla. Si debo llegar a ¬A, el supuesto debe ser A'
  DOBLE_NEGACION_REFERENCIAS_MULTIPLES:
    content: 'Para justificar una doble negación se debe remitir a una ' +
      'única fórmula previa'
  REPETICION_REFERENCIAS_MULTIPLES:
    content: 'Para justificar una repetición se debe remitir a una única ' +
      'fórmula previa'
  ...
  EFSQ_REFERENCIAS_MULTIPLES:
    content: 'Para justificar una EFSQ se debe remitir a una única fórmula ' +
      'previa'
  EFSQ_REFERENCIAS_INVALIDAS:
    content: 'Para justificar la aplicación de la regla EFSQ se debe remitir ' +
      'a una contradicción (⊥)'
  ...
  ELIMINACION_NEGACION_REFERENCIAS_INVALIDAS:
    content: '' +
      'La eliminación de la negación se fundamenta en dos fórmulas ' +
      'contradictorias. Por ejemplo: ' + '\n' +
	    '1:(pVq)' + '\n' +
	    '2:¬(pVq)' + '\n' +
	    '3:⊥ E¬(1,2)' + '\n' +
      'Debe asegurarse de indicar correctamente las fórmulas ' +
      'contradictorias, como así también verificar si son efectivamente ' +
      'contradictorias y responden al esquema A y ¬A'
  ELIMINACION_CONDICIONAL_REFERENCIAS_INVALIDAS:
    content: '' +
      'La regla de eliminación del condicional se justifica a partir de ' +
      'dos fórmulas previas, de las cuales, una tiene un condicional ' +
      'como conectiva dominante (A→B) y la otra remmite al antecedente ' +
      'del condicional formulado. Por ejemplo:' + '\n' +
      '1:(pVq)→p premisa' + '\n' +
      '2:(pVq) premisa' + '\n' +
      '3:p E→(1,2)' + '\n' +
  ...
  ELIMINACION_DISYUNCION_REFERENCIAS_INVALIDAS:
    content: '' +
      ...
      'partir de tres fórmulas previas, de las cuales,una de ellas tiene ' +
      'una disyunción como conectiva dominante, mientras que las otras dos, ' +
      'son condicionales que tienen como antecedente los disyuntos contenidos ' +
      'por la disyunción ofrecida y como consecuente la fórmula a la que se ' +
      'pretende arribar. Por ejemplo:' + '\n' +
      '1:pVq premisa' + '\n' +
      '2:p→s premisa' + '\n' +
      '3:q→s premisa' + '\n' +
      '4:s EV(1,2,3)' + '\n' +
  ...
  DOBLE_NEGACION_RESULTADO_INVALIDO:
    ...
    content: '' +
      'Para aplicar correctamente la regla de doble negación debe ' +
      'considerar que ' + '\n' +
  ...
  INTRODUCCION_NEGACION_ITERACION_INVALIDA:
    ...
    content: '' +
      'Para aplicar correctamente la regla de introducción de la negación ' +
      'se debe suponer' + '\n' +
      '${expresionNegada}' + '\n' +
  ...
  INTRODUCCION_CONDICIONAL_ITERACION_INVALIDA:
    ...
    content: '' +
      'Para aplicar correctamente la regla de introducción del condicional ' +
      'se debe suponer' + '\n' +
      '${leftExpression}' + '\n' +
  ...
  INTRODUCCION_CONJUNCION_REFERENCIA_INVALIDA:
    ...
    content: '' +
      'Para aplicar correctamente la regla de introducción la conjunción se ' +
  ...
  ITERACION_REFERENCIA_INVALIDA:
    ...
    content: '' +
      'Las referencias ofrecidas no se corresponden con un contexto de ' +
      'suposición adecuado.' + '\n' +
  ...
  ELIMINACION_CONJUNCION_REFERENCIA_INVALIDA:
    ...
    content:
      'Para generar ' + '\n' +
      '${expression}' + '\n' +
      'aplicando correctamente la regla de eliminación de la conjunción se ' +
      'debe partir de una formula de la forma' + '\n' +
      '${expression} Λ X'
  FORMULA_INVALIDA_LUEGO_DE_ITERACION:
    content: 'Luego de cancelar un supuesto la fórmula obtenida debe ' +
      'responder o al esquema de la regla de introducción de condicional o ' +
      'al esquema de la regla de introducción de la negación'
  FINALIZACION_EN_CIERRE_DE_ITERACION:
    content: 'La reglas que admiten supuestos requieren como resultado una ' +
      'fórmula particular. No pueden jamás finalizar en la cancelación del ' +
      'supuesto.'
  FINALIZACION_DENTRO_DE_ITERACION:
    content: 'Los supuestos deben cancelarse:' + '\n' +
      'Una vez que arribamos al resultado esperado, para denotar la cancelación ' +
      'del supuesto debe debe indicarlo con los símbolos '  + '\n' +
      '<<'
  CIERRES_DE_ITERACION_CONSECUTIVOS:
    content: 'Hay que cancelar correctamente los supuestos en caso de haber ' +
      'supuestos anidados. Teniendo primacía los últimos supuestos abiertos ' +
      'en el orden de su cancelación'
