window.ERROR_ELEMENT =
  ...
  INTRODUCCION_NEGACION_ITERACION_INVALIDA:
    ...
    content: '' +
      'Para introducir esta negación se debería suponer' + '\n' +
      '${expresionNegada}' + '\n' +
  ...
  INTRODUCCION_CONDICIONAL_ITERACION_INVALIDA:
    ...
    content: '' +
      'Para introducir este condicional se debería suponer' + '\n' +
      '${leftExpression}' + '\n' +
  ...
  INTRODUCCION_DISYUNCION_REFERENCIA_INVALIDA:
    ...
    content: '' +
      'Para introducir una disyunción debe estar afirmada al menos una de sus dos partes' + '\n' +
      '${leftExpression}' + '\n' +
      '${rightExpression}' + '\n' +
      'Asegurece también de indicar las referencias correctamente' 
  INTRODUCCION_CONJUNCION_REFERENCIA_INVALIDA:
    ...
    content: '' +
      'Para introducir una conjunción deben estar afirmadas sus dos partes' + '\n' +
      '${leftExpression}' + '\n' +
      '${rightExpression}' + '\n' +
      'Asegurece también de indicar las referencias correctamente' 
  ITERACION_REFERENCIA_INVALIDA:
    ...
    content: '' +
      'La referencias no se corresponden con el contexto de suposición.' + '\n' +
